         ...
         (defun my/erc-start-or-switch ()
           ...
           (if (get-buffer "irc.freenode.net:6667")
             ...
             (when (y-or-n-p "Start ERC? ")
               (erc :server "irc.freenode.net" :port 6667 :nick "x64Toaster"))))
         :config
...
**** eyebrowse
     ...
     #+BEGIN_SRC emacs-lisp
       (use-package eyebrowse
         :ensure t
         :general
         (:keymaps 'eyebrowse-mode-map "M-1" 'eyebrowse-switch-to-window-config-1)
         (:keymaps 'eyebrowse-mode-map "M-2" 'eyebrowse-switch-to-window-config-2)
         (:keymaps 'eyebrowse-mode-map "M-3" 'eyebrowse-switch-to-window-config-3)
         (:keymaps 'eyebrowse-mode-map "M-4" 'eyebrowse-switch-to-window-config-4)
         :config
         (eyebrowse-mode t)
