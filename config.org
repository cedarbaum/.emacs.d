...
*** Font
    ...
    Try to use either [[https://www.jetbrains.com/lp/mono/][JetBrains Mono]] or [[https://sourcefoundry.org/hack/][Hack]] font.

    #+BEGIN_SRC emacs-lisp
      (cond ((member "JetBrains Mono" (font-family-list)) (set-face-attribute 'default nil :font "JetBrains Mono-12"))
